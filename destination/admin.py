...
class UniversityAdmin(ModelAdmin):
    ...
    search_fields = ('destination', 'university_name', 'location')
    list_filter = ('date_added', 'is_deleted')
...
class DestinationFaqAdmin(ModelAdmin):
    ...
    search_fields = ('destination', 'question',)
    list_filter = ('date_added', 'is_deleted')
...
class VisaYourObligationsAdmin(ModelAdmin):
    ...
    search_fields = ('destination', 'description', 'content_1', 'content_3', 'content_5')
    list_filter = ('date_added', 'is_deleted')
...
class ScholarshipCardsAdmin(ModelAdmin):
    list_display = ('destination', 'title', 'image_alt', 'description', 'date_added', 'date_updated', 'is_deleted')
...
class ScholarshipsAdmin(ModelAdmin):
    ...
    search_fields = ('destination', 'title', 'university_name')
    list_filter = ('date_added', 'is_deleted')
...
class CostOfStudyAdmin(ModelAdmin):
    ...
    search_fields = ('destination', 'page_title', 'tuition_bachelor', 'tuition_postgrad')
    list_filter = ('date_added', 'is_deleted')
