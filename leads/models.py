...
#     nearest_office = models.ForeignKey(BranchDetails, on_delete=models.CASCADE, blank=True, null=True)
...
# #     preferred_intake = models.ForeignKey(Intake, on_delete=models.CASCADE, null=True, blank=True)
...
# #     email = models.EmailField(max_length=255, null=True, blank=True)
# #     phone = models.CharField(max_length=18, blank=True, null=True)
# #     preferred_centre = models.ForeignKey(ExamCentres, on_delete=models.CASCADE, null=True, blank=True)
